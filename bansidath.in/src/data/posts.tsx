        ...
        content: (
            <div className="te">
                ...
                <figure className="plate">
                    <img src="/rdr5.png" alt="రాత్రి ఆకాశం కింద గుర్రం మీద ఆగిన ప్రయాణికుడు, పైన పాలపుంత" />
                    <figcaption>ఈ ప్రపంచం మనం చూడనప్పుడు కూడా ఉంటుంది</figcaption>
                </figure>
                ...
                <figure className="plate">
                    <img src="/rdr1.png" alt="ముఖం కప్పుకుని రెండు తుపాకులతో ఆవిరిలో నడిచి వస్తున్న అర్థర్" />
                    <figcaption>మనం కలిసేటప్పటికి అతను ఇలాంటివాడు</figcaption>
                </figure>
                <p>
                ...
                <figure className="plate">
                    <img src="/rdr3.png" alt="డచ్ వాన్ డెర్ లిండ్ ముందు నిలబడగా చుట్టూ ముఠా సభ్యులు" />
                    <figcaption>ముందు నిలబడినవాడు డచ్. ఒకప్పుడు వీళ్ళందరూ ఆ మాటలు నమ్మారు</figcaption>
                </figure>
                <p>
                ...
                <figure className="plate">
                    <img src="/rdr4.png" alt="కొండ మీద నేల మీద పడి ఉన్న అర్థర్, ఎదురుగా సూర్యోదయం" />
                    <figcaption>ఎదురుగా సూర్యుడు పైకి వస్తాడు</figcaption>
                </figure>
                ...
                <figure className="plate narrow">
                    <img src="/rdr2.png" alt="కొండ అంచున గుర్రం మీద ఒంటరి ప్రయాణికుడు, ఎదురుగా లోయ" />
                    <figcaption>కంచెలు రాకముందటి భూమి</figcaption>
                </figure>
                <p>
    ...
    },
    {
        ...
        content: (
            <div className="te">
                ...
                <p>
                    వారణాసి రాజమౌళి గారి అత్యంత ప్రతిష్ఠాత్మక ప్రాజెక్ట్. ఆయన చాలాసార్లు చెప్పారు, తన పాత సినిమాల ఫలితాలు తన తరువాతి సినిమాను ప్రభావితం చేయవని. ఆర్ఆర్ఆర్‌కు వచ్చిన ప్రపంచ గుర్తింపు దాదాపు యాదృచ్ఛికం. ఈసారి ఆయనకు ప్రపంచ స్థాయిలో తనను తాను నిరూపించుకోవాలి.
                </p>
                <p>
